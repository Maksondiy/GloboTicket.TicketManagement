...
namespace GloboTicket.TicketManagement.Persistence
{
    public class GloboTicketDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                RoomId = Guid.Parse("89C0C8F1-5911-41EC-9F43-E66388409D86"),
                Name = "Family Suite",
                Price = 300,
            });
            modelBuilder.Entity<Room>().HasData(new Room
            {
                RoomId = Guid.Parse("E7515010-B1DA-4EDE-94A4-0724BAFF54D8"),
                Name = "Family Suite",
                Price = 300,
            });
            modelBuilder.Entity<Room>().HasData(new Room
            {
                RoomId = Guid.Parse("39561959-DB4B-4894-A5DC-497713074CB0"),
                Name = "Business Suite",
                Price = 600,
            });
            modelBuilder.Entity<Room>().HasData(new Room
            {
                RoomId = Guid.Parse("D37304A2-1117-447F-AAF1-B9386F97505C"),
                Name = "Royal Suite",
                Price = 1000,
            });
            modelBuilder.Entity<Room>().HasData(new Room
            {
                RoomId = Guid.Parse("2E5948BB-07BB-44F8-9732-132BBAABC3AD"),
                Name = "FamilySuite",
                Price = 300,
            });
        }
